...
-src/toplevel_DCT.vhd
	- src/LoadController.vhd: Loads pixels from the BRAM holding the original image
			and feeds them to the DCT_8x8_MAC in a predefined order
...
tb/tb_Load_Controller.vhd: Instantiates the LoadController module as device
							under test. Compare output file with 
							run/Load_Controller_Output_ref.txt
